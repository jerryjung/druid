...
public class JDBCTuningConfigTest
{
  private final ObjectMapper mapper;

  public JDBCTuningConfigTest()
  {
  ...
  {
    String jsonStr = "{\"type\": \"jdbc\"}";

    JDBCTuningConfig config = (JDBCTuningConfig) mapper.readValue(
  ...
  {
    JDBCTuningConfig original = new JDBCTuningConfig(
        1,
        2,
        new Period("PT3S"),
        new File("/tmp/xxx"),
    ...
    JDBCTuningConfig copy = JDBCTuningConfig.copyOf(original);
