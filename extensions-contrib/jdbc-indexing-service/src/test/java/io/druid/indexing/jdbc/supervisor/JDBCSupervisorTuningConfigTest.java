...
public class JDBCSupervisorTuningConfigTest
{
  private final ObjectMapper mapper;

  public JDBCSupervisorTuningConfigTest()
  {
  ...
  public void testSerdeWithDefaults() throws Exception
  {
   ...
   JDBCSupervisorTuningConfig config = (JDBCSupervisorTuningConfig) mapper.readValue(
