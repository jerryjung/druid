...
public class JDBCTuningConfig implements TuningConfig, AppenderatorConfig
{
  ...
  public static JDBCTuningConfig copyOf(JDBCTuningConfig config)
  {
    return new JDBCTuningConfig(
  ...
  public JDBCTuningConfig withBasePersistDirectory(File dir)
  {
    return new JDBCTuningConfig(
        maxRowsInMemory,
        maxRowsPerSegment,
  ...
  public JDBCTuningConfig withMaxRowsInMemory(int rows)
  {
    return new JDBCTuningConfig(
        rows,
        maxRowsPerSegment,
  ...
  public boolean equals(Object o)
  {
    ...
    JDBCTuningConfig that = (JDBCTuningConfig) o;
