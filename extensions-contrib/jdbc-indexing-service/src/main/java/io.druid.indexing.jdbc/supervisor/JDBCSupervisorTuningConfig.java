...
public class JDBCSupervisorTuningConfig extends JDBCTuningConfig
{
  ...
  public JDBCSupervisorTuningConfig(
  ...
  )
  {
    super(
        ...
        // Supervised kafka tasks should respect JDBCSupervisorIOConfig.completionTimeout instead of
  ...
  {
    return "JDBCSupervisorTuningConfig{" +
