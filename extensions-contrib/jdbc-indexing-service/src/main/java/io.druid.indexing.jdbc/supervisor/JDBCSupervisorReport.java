...
public class JDBCSupervisorReport extends SupervisorReport
{
  public static class JDBCSupervisorReportPayload
  {
    ...
    private final Long latestOffsets;
    private final Long minimumLag;
    private final Long aggregateLag;
    private final DateTime offsetsLastUpdated;

    public JDBCSupervisorReportPayload(
        String dataSource,
        String table,
        Integer partitions,
        Integer replicas,
        Long durationSeconds,
        @Nullable Long latestOffsets,
        @Nullable Long minimumLag,
  ...
  private final JDBCSupervisorReportPayload payload;

  public JDBCSupervisorReport(
      String dataSource,
  ...
  )
  {
    ...
    this.payload = new JDBCSupervisorReportPayload(
        dataSource,
        topic,
        partitions,
        replicas,
